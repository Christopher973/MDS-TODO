  ...
  scenario('creates a task', async (scenario: StandardScenario) => {
    const result = await createTask({
      input: {
        ...
        startDate: '2025-01-16T11:19:45.257Z',
        updatedAt: '2025-01-16T11:19:45.257Z',
      },
    })
    ...
    expect(result.startDate).toEqual(new Date('2025-01-16T11:19:45.257Z'))
    expect(result.updatedAt).toEqual(new Date('2025-01-16T11:19:45.257Z'))
  })
